...
public class Entity : MonoBehaviour
{
    ...
    {
        var hits = Physics.BoxCastAll(transform.position - (height/2f) * Vector3.up + 0.2f * Vector3.up, new Vector3(size/2f-0.01f, 0.1f, size/2f-0.01f), Vector3.down, Quaternion.identity, 0.2f, 1 << 8);
        if (hits.Length > 0)
        {
